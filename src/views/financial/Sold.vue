        ...
        <el-main id="main" style="height:900px;padding:0" align="center">
          ...
          >
            ...
            <!-- <el-table-column align="center" label="产品规格">
              <template slot-scope="scope" >
                {{ scope.row['order']['products'][0].productScale }}
              </template>
            </el-table-column> -->
            <!-- <el-table-column align="center" label="销售数量">
              <template slot-scope="scope" >
                {{ scope.row['order']['products'][0].orderNum }}
              </template>
            </el-table-column> -->
            ...
            <!-- <el-table-column align="center" label="利润">
              <template slot-scope="scope">
                {{ (scope.row['order']['products'][0].productResale - scope.row['order']['products'][0].productCost) * scope.row['order']['products'][0].orderNum + '元'}}
              </template>
            </el-table-column> -->
